...
1. **Host creates a room:**
   ...
   - Host shares the room code with their friend

2. **Peer joins the room:**
   - Peer clicks "Join Game" and enters the room code
...
- `POST /api/webrtc/create-room` - Creates a new room and returns a room code
